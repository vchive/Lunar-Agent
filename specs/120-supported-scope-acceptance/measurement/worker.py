...
from campaign import REPO, canonical, sha, shared_module, verify, write_new
from response_guard import RuntimeGuard

_shared_runtime = shared_module("runtime_guard")
installed_guard, load_provider = _shared_runtime.installed_guard, _shared_runtime.load_provider

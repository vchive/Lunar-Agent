...
The 2026-09-21 audit reopens T006 and T007: their original fixtures passed, but three local
counterexamples show the acceptance is incomplete. T008 and T010 below describe the original
validation and delivery, not acceptance of the newly identified repairs.
...
- [ ] T006 Complete runtime/process cancellation and cleanup acceptance; preserve unrelated workers
      with real local process fixtures, after T011, T013, and T014.
- [ ] T007 Complete owner-scoped restart reconciliation and `lost` acceptance after T012.
...
## Reopened acceptance, 2026-09-21

- [ ] T011 Isolate adapter execution and cancellation per attempt. With two active workers selecting
...
- [ ] T012 Establish owner identity/liveness and restrict reconciliation to verified interrupted
      ...
      remain unchanged.
- [ ] T013 Check authoritative attempt state before adapter invocation and release handles by exact
...
- [ ] T014 Wire actual runtime process observers and verified cleanup to worker attempts. Local
...
- [ ] T015 Add permanent regressions for the three reproduced counterexamples and the T011–T014
...
- [ ] T016 Review and document the completed hardening, update HANDOFF, and commit/push only the

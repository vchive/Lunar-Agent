...
PRODUCT_COMMIT = "eefe389d14c2380ceb7db9089636f6a5ebe15e2a"
CAMPAIGN_ID = "diagnostic125-glm-5.2-snapshot-protocol-20260917"
LIMITS = {"request_seconds": 600, "wall_seconds": 1320, "max_requests": 2,
          "token_stop_threshold": 160000, "holdout_seconds": 5}
REFERENCE = REPO / "specs/123-small-evaluator-diagnostic/measurement/manifest.json"
REFERENCE_SHA = "9d05c7d95eb427f60d7be7a93dbfb8c7c53ec50904169e0391053292315f60a7"
...
def fixed_conditions():
    ...
    with tempfile.TemporaryDirectory(prefix="lunar125-profile-") as directory:
    ...
    unchanged = (
        "contract", "contract_sha256", "input_utf8", "input_sha256", "input_profile",
...
def measurement_paths():
    return [*HERE.glob("*.py"), *(HERE.parent / name for name in
            ...
            *REPO.glob("tests/test_measurement125_*.py")]


def historical_paths():
    return [p for number in (113, 115, 117, 120, 121, 122, 123, 124)

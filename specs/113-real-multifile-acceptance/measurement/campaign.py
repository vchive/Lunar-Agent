"""One fixed, failure-preserving real-model acceptance campaign. No historical imports."""
...
PRODUCT_COMMIT = "c977eb4da528cb1ab2a98958cf0b54a01869d347"
CAMPAIGN_ID = "acceptance113-glm-5.2-multifile-20260916"
...
def prepare():
    from runtime_guard import load_provider
    if MANIFEST.exists():
...
def verify(*, committed=False):
    ...
    for group in ("product_files", "measurement_files"):
...
def summarize(manifest):
    from analyze import analyze_slot

...
from tasks import CASES, holdouts, optimum
...
PRODUCT_COMMIT = "9a26a73e38d52b18f003b262a8746bb22496c156"
CAMPAIGN_ID = "acceptance117-glm-5.2-extended-deadline-20260916"
LIMITS = {"wall_seconds": 3600, "request_seconds": 600, "max_requests": 16,
          "token_stop_threshold": 160000, "tool_steps_per_invocation": 4}
REFERENCE = HERE.parents[1] / "115-isolated-intake-acceptance/measurement"
REFERENCE_SHA256 = "a4be47bfc2d6d02446fac1834f34ce8176a92017694cb6d71f8508e364f8a6c9"
FIXED_FIELDS = ("provider", "cases", "holdouts", "optima", "population",
                "runtime_options", "sampling", "schedule", "planned_attempts", "concurrency",
                "retries_or_replacements", "primary", "failure_quality", "cost_micros")
...
def check_fixed_conditions(payload):
    ...
    expected_limits = {**reference["limits"], "wall_seconds": 3600, "request_seconds": 600}
...
def condition_changes(reference):
    return {
        ...
        "wall_seconds": {"before": reference["limits"]["wall_seconds"], "after": 3600},
        "request_seconds": {"before": reference["limits"]["request_seconds"], "after": 600},
    }
...
def prepare():
    ...
    payload = {
        ...
        "previous_campaign": "acceptance115-glm-5.2-isolated-intake-20260916",
        ...
        "primary": "verified multi-file delivery with independently feasible outputs / 2 planned attempts",
        "limitations": ["two_hand_authored_tasks_one_attempt_each", "no_normal_or_webagent_control",
                        "product_and_deadlines_changed_not_a_causal_comparison",
...
def summarize(manifest):
    analyze_slot = shared_module("analyze").analyze_slot

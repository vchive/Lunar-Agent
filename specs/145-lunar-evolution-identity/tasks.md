...
- [x] T001 Define the new identity and inspect product and frozen evidence dependencies.
- [x] T002 Preserve private state and create the neutral immutable archive index.
- [x] T003 Separate historical tests and implement the explicit archived regression phase.

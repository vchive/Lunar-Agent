...
PRODUCT_COMMIT = "5e2568f286b709c7f8bd4c883bf654582908e736"
CAMPAIGN_ID = "acceptance115-glm-5.2-isolated-intake-20260916"
LIMITS = {"wall_seconds": 1200, "request_seconds": 180, "max_requests": 16,
          "token_stop_threshold": 160000, "tool_steps_per_invocation": 4}
REFERENCE_SHA256 = "9f30acf0db6e672331c86a3efc46a964fb71d4c1d8a4cd2fe287ee9ec8e6e367"
FIXED_FIELDS = ("provider", "limits", "cases", "holdouts", "optima", "population",
...
def check_fixed_conditions(payload):
    reference_path = SHARED / "manifest.json"
...
def prepare():
    ...
    payload = {
        ...
        "historical_files": file_pins([*SHARED.parent.rglob("*.md"), *SHARED.glob("*.py"),
                                      SHARED / "manifest.json", *SHARED.parent.glob("postrun/*.json")]),
        "previous_campaign": "acceptance113-glm-5.2-multifile-20260916",

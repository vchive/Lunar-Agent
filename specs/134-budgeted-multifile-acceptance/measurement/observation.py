...
The ledger retains its original admission, accounting and stop rules. After durable accounting,
the direct owned model failure is restored for native preparation diagnostics. Observation extracts
safe metadata only after accounting; exchange returns/rethrows the original native object.
...
def _load_shared_runtime():
    ...
    name = "_lunar_measurement134_frozen113_runtime_guard"

# Feature Specification: Executable reference-benchmark Adapters

**Feature Branch**: `049-reference-benchmark-adapters`
**Created**: 2026-09-04
**Status**: Implemented
...
normal Lunar subject, private reference-benchmark harness, and FM-Eval export as external commands. This feature
...
1. The effect runner invokes `lunar-evolution effect-subject` with a Feature 048 request.
...
1. The effect runner invokes `lunar-evolution effect-harness` with a Feature 048 harness request and an
...
- Bundling external reference-benchmark case files, extractor dependencies, credentials, or a historical `1.10.6` release.

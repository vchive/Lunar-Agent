"""Read-only validation for a frozen reference-benchmark effect trial.
...
def run_effect_preflight(
    ...
    *,
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="lunar-evolution-effect-preflight-") as temporary:
    ...
    report: dict[str, Any] = {
        "schema_version": "1",
        "protocol": "reference-benchmark-effect-preflight-v1",
        "status": "ready",

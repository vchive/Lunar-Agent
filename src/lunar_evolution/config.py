...
class Config:
    ...
    def from_env(cls, home: str | Path | None = None) -> Config:
        configured_home = home if home is not None else os.environ.get("LUNAR_EVOLUTION_HOME", ".lunar-evolution")
        max_retries = int(os.environ.get("LUNAR_EVOLUTION_MAX_RETRIES", "2"))
        timeout = float(os.environ.get("LUNAR_EVOLUTION_RUNTIME_TIMEOUT", "900"))

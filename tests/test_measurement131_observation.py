...
HELPER = ROOT / "specs/131-small-multifile-recheck/measurement/observation.py"
spec = importlib.util.spec_from_file_location("measurement131_observation_test", HELPER)
...
def test_loader_uses_unique_module_without_search_path_mutation():
    ...
    assert shared.__name__ == "_lunar_measurement131_frozen113_runtime_guard"

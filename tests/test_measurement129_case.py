...
CASE_PATH = (Path(__file__).resolve().parents[1]
             / "specs/129-small-multifile-acceptance/measurement/case.py")
...
@pytest.fixture
def case():
    spec = importlib.util.spec_from_file_location("measurement129_case", CASE_PATH)
...
def fixture_contract():
    ...
    return AlgorithmProblemContract.from_dict({
        "schema_version": "1", "problem_id": "offline129", "problem_type": "continuous",

"""The registered 123 case uses native snapshot execution and exact holdout scoring."""
...
CASE_PATH = (Path(__file__).resolve().parents[1]
             / "specs/123-small-evaluator-diagnostic/measurement/case.py")


@pytest.fixture
def case():
    spec = importlib.util.spec_from_file_location("measurement123_case", CASE_PATH)

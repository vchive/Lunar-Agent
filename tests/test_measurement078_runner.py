...
_spec = importlib.util.spec_from_file_location("offline078_runner_adapter", ADAPTER)
...
# is replaced below; every native worker/receipt/launch scenario now receives the 078 adapter.
...
def test_all_wrappers_bind_new_paths_implementation_and_prior_profile_source(adapter):
    ...
    assert prepare.PRIOR_ROOT == "specs/076-public-plan-handoff-measurement"

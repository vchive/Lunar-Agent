...
HELPER = ROOT / "specs/129-small-multifile-acceptance/measurement/observation.py"
spec = importlib.util.spec_from_file_location("measurement129_observation_test", HELPER)
...
def test_loader_uses_unique_module_without_search_path_mutation():
    ...
    assert shared.__name__ == "_lunar_measurement129_frozen113_runtime_guard"

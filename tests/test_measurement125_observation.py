"""Offline evidence that the 125 observer preserves frozen request accounting and transport."""
...
HELPER = ROOT / "specs/125-snapshot-protocol-diagnostic/measurement/observation.py"
spec = importlib.util.spec_from_file_location("measurement125_observation_test", HELPER)
...
def test_loader_uses_unique_module_without_search_path_mutation():
    ...
    assert shared.__name__ == "_lunar_measurement125_frozen113_runtime_guard"

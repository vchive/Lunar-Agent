...
CASE_PATH = (Path(__file__).resolve().parents[1]
             / "specs/131-small-multifile-recheck/measurement/case.py")
...
@pytest.fixture
def case():
    spec = importlib.util.spec_from_file_location("measurement131_case", CASE_PATH)
...
def fixture_contract():
    ...
    return AlgorithmProblemContract.from_dict({
        "schema_version": "1", "problem_id": "offline131", "problem_type": "continuous",
